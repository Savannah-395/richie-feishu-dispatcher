...
export const config = {
  ...
  codex: {
    ...
    githubProjectRepos: readCsv("RICHIE_GITHUB_PROJECT_REPOS"),
    githubExcludedProjectRepos: readCsv("RICHIE_GITHUB_EXCLUDED_PROJECT_REPOS"),
    githubProjectCloneRoot: process.env.RICHIE_GITHUB_PROJECT_CLONE_ROOT?.trim() || "",
